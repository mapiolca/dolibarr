...
/**
 *		\file       htdocs/theme/brenda/global.inc.php
 *		\brief      File for CSS style sheet Brenda. Called by style.css.php.
 */
...
include dol_buildpath($path.'/theme/'.$theme.'/brenda.inc.php', 0);
