...
/**
 *		\file       htdocs/theme/brenda/style.css.php
 *		\brief      File for CSS style sheet Brenda
 */
...
$fontlist = '"Segoe UI",Roboto,Helvetica,Arial,sans-serif';
...
if (!getDolGlobalString('THEME_ELDY_ENABLE_PERSONALIZED')) {
	$conf->global->THEME_ELDY_BACKTABCARD1 = $colorbacktabcard1; // card
	$conf->global->THEME_ELDY_BACKTABACTIVE = $colorbacktabactive;
	$conf->global->THEME_ELDY_TEXT = $colortext;
